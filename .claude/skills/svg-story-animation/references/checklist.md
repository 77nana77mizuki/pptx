...
- [ ] 静止した絵（イラスト・背景装飾）が汎用ストック素材のリカラーだけになっていないか。[illustration-styles.md](illustration-styles.md) の6つの語彙から、デッキに1つ以上「その資料固有」の表現を入れているか
- [ ] 背景の点と線のネットワークやアイコンタイルなど、同じ装飾意匠を全ページで使い回していないか（ヒーロー・クロージングなど限定箇所以外）
